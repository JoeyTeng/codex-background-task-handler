...
- Blockers:
  ...
  - Desktop writeback helpers, boundary crossing, binding lifecycle, and several daemon deadline/recovery contracts remain incomplete.
- Evidence:
  - Release: `v0.1.0`
...
- Desktop heartbeat / helper execution still needs no-approval validation before `read_transport_capability` or writeback capability can be treated as `validated`.
