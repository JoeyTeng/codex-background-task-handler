...
- Next Steps:
  - Continue daemon upgrade safety from [daemon upgrade safety](project_journal/2026/05/2026-05-11-daemon-upgrade-safety-5721.md): the five safety PRs are complete after PR5 lands; the held `0.2.0` release PR remains next.
