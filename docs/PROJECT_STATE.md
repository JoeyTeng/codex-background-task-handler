...
- Phase: CLI operator UX implementation complete; broader CLI/Desktop follow-ups remain active.
- Summary: The managed resume path and Codex 0.129 permission selection follow-ups are complete, and `cbth` now has clearer help, `cli app-servers --format json|human`, and `self update --interactive`.
- Next Steps:
