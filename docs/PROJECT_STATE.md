...
- 本仓用于在不修改上游 `codex` 的前提下验证和实现 `cbth` background task handler；当前主线已经完成 CLI dogfood v1 的主要能力、`v0.2.0` daemon upgrade safety release，以及 Desktop bridge foundation。
...
- Next Steps:
  ...
  - Desktop writeback live validation is tracked in [Desktop writeback helper live validation](project_journal/2026/05/2026-05-07-desktop-writeback-live-validation-922c89c.md), [Desktop writeback dropbox probe](project_journal/2026/05/2026-05-11-desktop-writeback-dropbox-probe-2b4ea02.md), [Desktop transcript relay validation](project_journal/2026/05/2026-05-11-desktop-transcript-relay-validation-eeef583.md), [Desktop transcript relay consumer](project_journal/2026/05/2026-05-11-desktop-transcript-relay-consumer-00afcf6.md), [Desktop transcript relay consumer live validation](project_journal/2026/05/2026-05-11-desktop-transcript-relay-consumer-live-validation-0796bf3.md), and [Desktop transcript relay production scanner](project_journal/2026/05/2026-05-12-desktop-transcript-relay-production-scanner-f4b2e32.md).
...
- Desktop direct writeback is blocked by heartbeat-owned startup-lock access and local filesystem write denial; transcript relay writeback is live-validated, while scanner live validation, boundary crossing, binding lifecycle cleanup, artifact reads, and several daemon deadline/recovery contracts remain incomplete.
- Evidence:
  - Release: `v0.2.0`
  ...
  - Design docs: [SHARED_CORE_ARCHITECTURE.md](design/SHARED_CORE_ARCHITECTURE.md), [DESKTOP_BRIDGE_FOUNDATION.md](design/DESKTOP_BRIDGE_FOUNDATION.md), [DESKTOP_LIVE_PREFLIGHT_VALIDATION.md](validation/DESKTOP_LIVE_PREFLIGHT_VALIDATION.md), [DESKTOP_WRITEBACK_HELPER_LIVE_VALIDATION.md](validation/DESKTOP_WRITEBACK_HELPER_LIVE_VALIDATION.md), [DAEMON_UPGRADE_SAFETY.md](plans/DAEMON_UPGRADE_SAFETY.md), [LIVE_E2E.en-GB.md](LIVE_E2E.en-GB.md)

## Risks Or Open Questions

- Desktop no-DB inbox reads and transcript relay writeback are validated, and production cursor/tailer foundation now exists, but scanner live validation and artifact-read capability are still incomplete.
