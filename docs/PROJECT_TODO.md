...
- [in_progress] Finish Desktop bridge transcript-relay writeback live validation, production cursor/tailer, binding lifecycle, artifact-read policy, and continuation-boundary contracts.
- [pending] Finish remaining CLI/daemon recovery, fixed-thread contract work, and daemon upgrade safety follow-ups: PR4 app-server handoff, PR5 jobs drain, then the held `0.2.0` release PR.
