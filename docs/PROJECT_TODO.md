...
- [in_progress] Finish Desktop ready materialization, caller wake, binding lifecycle, artifact-read policy, and continuation-boundary contracts now that transcript relay production scanner live validation is complete.
