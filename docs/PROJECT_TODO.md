...
- [in_progress] Finish Desktop caller wake, pause/binding lifecycle, artifact-read policy, and continuation-boundary contracts; ready/arm workflow detail is in [Desktop ready materialization and arm workflow](project_journal/2026/05/2026-05-13-desktop-ready-arm-workflow-143a38f.md), with broader canonical follow-up detail in [current follow-ups](project_journal/2026/05/2026-05-05-current-follow-ups-bbe4003.md).
...
- [pending] Implement host-level plugin runtime and generic delivery in the C1-C7 / W1-W7 sequence recorded in [Host plugin runtime design](project_journal/2026/05/2026-05-13-host-plugin-runtime-design-143a38f.md).
