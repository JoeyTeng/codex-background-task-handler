...
- [pending] Finish remaining CLI/daemon recovery, fixed-thread contract work, and daemon upgrade safety follow-ups: PR5 jobs drain, then the held `0.2.0` release PR.
